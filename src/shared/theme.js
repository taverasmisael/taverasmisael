...
const MainTheme = {
  typography: {
    ...
    h1: { fontFamily: bodyFontFamily, fontSize: '3.25rem', lineHeight: 1.15 },
    h2: {
      fontFamily: headingFontFamily,
      fontSize: '2.75rem',
      lineHeight: 1.25,
    },
    h3: { fontFamily: headingFontFamily, fontSize: '2.5rem', lineHeight: 1.35 },
    h4: {
      fontFamily: headingFontFamily,
      fontSize: '1.75rem',
      lineHeight: 1.45,
    },
    h5: { fontFamily: headingFontFamily, fontSize: '1.5rem', lineHeight: 1.5 },
