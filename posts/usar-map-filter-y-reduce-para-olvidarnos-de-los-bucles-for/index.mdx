...
tags: ['Tutorial', 'JavaScript', 'Programación Funcional']
keywords: map, filter, reduce, bucle for, mejorar bucle for, ejemplos map, ejemplo reduce, javascript funcional, ejemplos filter javascript
...
En Javascript hay 3 diferentes de bucles for que podemos utilizar. Cada uno con nos da diferentes
...
/* Con funciones flecha. Estaré usando esta sintaxis de ahora en adelante */
