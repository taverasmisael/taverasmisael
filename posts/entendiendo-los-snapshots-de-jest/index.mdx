...
En este post aprenderemos todo de ella, como usarla en nuestros tests para probar más con menos código y aumentar la confianza en nuestro código.
...
En este articulo hemos explorado una de las herramientas que tenemos a la mano para probar nuestro código. **Si eliminamos la fricción que existe para empezar a crear test, es más probable que empecemos a hacerlos.** Ya no hay excusas para no agregar tests a tus aplicaciones.
